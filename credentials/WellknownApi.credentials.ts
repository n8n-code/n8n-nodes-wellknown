...
export class WellknownApi implements ICredentialType {
	name = 'N8nDevWellknownApi';

	displayName = 'wellknown API';

	icon: Icon = { light: 'file:../nodes/Wellknown/wellknown.png', dark: 'file:../nodes/Wellknown/wellknown.dark.png' };
	...
	properties: INodeProperties[] = [
		{
			...
			name: 'url',
			type: 'string',
			default: 'https://wellknown.ai/api',
			required: true,
			placeholder: 'https://wellknown.ai/api',
			description: 'The base URL of your wellknown API server',
		},
		{
			displayName: 'API Key',
			name: 'apiKey',
